...
# Titles lack the pointer to the trait name. Anyway, I may get rid of titles altogether
# Remove "NA" from legend
# Considering (not sure) to add alpha besides theta
# The numeric scale at the bottom is meaningless
# I think it needs thicker lines
