...
**OBJETIVO_2.1.Traitsv2.R** Crea tabla con los traits para cada comunidad y calcula las medidas de resumen para estos. Además de un árbol con todas las comunidades y los traits anotados al final de él.
