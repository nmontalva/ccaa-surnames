...
### Resultados
- [ ] Poner las figuras de los resultados y redactar su descripción y sus referencias en el texto \<- @VasEstay
- [ ] Arreglar las tablas, sus textos descriptivos y sus referencias en el texto \<- @VasEstay
- [ ] Revisar los números \<- @VasEstay
- [ ] Revisar redacción \<- @VasEstay
- [ ] Revisar citas que falten en los resultados \<- @VasEstay
